...
import { enhanceWithOpenFDA } from './src/services/openFDAService';
...
export default function App() {
  ...
  const processImage = async (imageData) => {
    ...
    try {
      ...
      // Enhance with FDA data
      const enhancedInfo = await enhanceWithOpenFDA(analysisText, extractedName);
      
      // Format and set results
      const formattedInfo = formatMedicineInfo(enhancedInfo, extractedName);
      ...
      // Check for warnings
      if (checkForWarnings(enhancedInfo)) {
